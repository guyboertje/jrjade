...
public abstract class Node implements Cloneable {
    ...
    public abstract void execute(ScriptWriter writer, JadeModel model, JadeTemplate template) throws JadeCompilerException;
    
    public void accept(BaseWriter writer, JadeModel model, JadeTemplate template ){
        writer.visit(this, model, template);
    }
